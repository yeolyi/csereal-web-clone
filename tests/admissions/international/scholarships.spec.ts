...
test('외국인 장학금 편집 및 한/영 내용 검증', async ({ page }) => {
  ...
  await page.waitForURL('**/admissions/international/scholarships/edit');
  ...
  await page.waitForURL('**/admissions/international/scholarships');
  ...
  await switchPageLanguage(
    page,
    'en',
    '/admissions/international/scholarships',
  );
